...
The dimension of $\text{DH}_n$ was conjectured to count parking functions on $n$ cars,
$(n+1)^{n-1}$ while
the bigraded dimension of the submodule of $\text{DH}_n$ affording the
sign representation was defined to be the
$q,t$-Catalan polynomial, $C_n(q,t)$, since
this polynomial has the property that $C_n(1,1)$ is
...
Dyck paths and together formed the conjecture
\[
C_n(q,t) =
...
size $n$.
Garsia and Haglund worked together
...
\end{wrapfigure}
Adriano spent the following 24 years contributing his
