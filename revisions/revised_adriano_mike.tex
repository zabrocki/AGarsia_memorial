...
\author{
  Jennifer Morse
  \affil{
Morse is a professor of mathematics at University of Virginia.
    Her email address is {\tt morsej@virginia.edu}.
    }
  \and
  Mike Zabrocki
  \affil{
    Zabrocki is a professor of mathematics at York University in
...
\end{wrapfigure}
  math with Loewner in a van overlooking the ocean.
That %experience
...
Adriano first invited Ian Macdonald to lecture at UCSD in 1988. There, Macdonald
...
$(n+1)^{n-1}$ while
the bigraded dimension of the submodule of $\text{DH}_n$ affording the
sign representation was defined to be $C_n(q,t)$.
...
The $\nabla$ operator encoded all of this information
in symmetric function identities
and it was much later discovered to
have broader connections to knot theory and
constructions within algebra such as
the elliptic Hall algebra and double affine Hecke algebra.

In 2000 Jim Haglund found a long sought
after piece of a combinatorial formula for $C_n(q,t)$
by defining the `bounce' statistic on Dyck paths.
The `area' of a Dyck path
was already a familiar statistic on
Dyck paths and Haglund's conjecture was
\[
C_n(q,t) =
\sum_{\pi} q^{{\rm area}(\pi)} t^{{\rm bounce}(\pi)}
\]
where the sum is over all Dyck paths $\pi$ of
size
...
\end{wrapfigure}
$n$.  Garsia and Haglund worked together
over that summer connecting the symmetric function identities
with the combinatorics of Dyck paths and to prove this
formula.  Simultaneously, Mark Haiman was finalizing
his algebraic geometric program for proving the $n!$-conjecture.

%The discoveries in $q,t$-combinatorics and
%representation theory are still extremely active.
%and strongly influenced by this early work.
...
Adriano contributed over the next 20 odd years his
mathematical discoveries and
infectious enthusiasm for the field.
He believed that the most profound truths were
those that could be grasped with elegance and joy.
We asked some of his colleagues and students to
share some of their memories of how he touched their
...
\begin{wrapfigure}{r}{0.35\textwidth}
  ...
  {\footnotesize Adriano, Richard Stanley, Anders at Banff Conference on Ordered Sets, 1981}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
  ...
  {\footnotesize UCSD Combinatorics Seminar, Del Mar, 1981, Adriano, Richard Stanley, Michelle, Dennis Stanton, Jeff Remmel}
\end{wrapfigure}
...
When thinking about Adriano, countless dinner stories come to mind. He was passionate about life, and it was around the making and enjoyment of food that one got to know him more deeply. 
