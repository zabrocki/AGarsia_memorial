...
In that area, he is often remembered for a
three line proof of an inequality due to Hopf
that surprised many in the field because earlier proofs
of this result were 50 pages long.  Adriano had an ability to ``rewrite''
...
and he published several books, including two coauthored with \"Omer E\u{g}ecio\u{g}lu in his nineties.
...
Adriano's work was influential and he made foundational contributions to the study of
...
By the end of the 1980s, Adriano
invited Ian Macdonald to lecture at UCSD in 1988. There, Macdonald
...
Garsia proposed to construct an underlying representation-theoretic
...
With Claudio Procesi, they gave a new
...
and whose Frobenius image is a Macdonald polynomial.
