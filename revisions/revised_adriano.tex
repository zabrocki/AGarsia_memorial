...
Many of the themes that shaped his later work can already be seen in his early contributions to analysis.

One particularly influential line of research from this period
concerns what are now called $\beta$-expansions and the
entropy phenomena associated with them.
For a base $\beta > 1$ and for a fixed $n$
(generally not an integer),
the distribution
\[
S_n = \sum_{k=1}^{n} \epsilon_k \beta^{-k}
\]
with $\epsilon_k \in \{0,1\}$ are known as
$\beta$-expansions.  For most values of $\beta$,
...
the Bernoulli convolution is still open.
  ...
  \centering
\includegraphics[width=1.3in]{../images/mathtalkwadriano.jpg} \\
{\footnotesize
His passion for math was contagious
}
\end{wrapfigure}

This ability to uncover structural simplicity beneath
phenomena was equally characteristic of his work in ergodic theory.
...
of this result were 50 pages long.
...
He published several books over his career,
including two with \"Omer E\u{g}ecio\u{g}lu while in his 90s.
...
His best known result in real and functional analysis
...
In the mid-1970's, Alain Lascoux visited
...
(more abstract and more powerful generality).
...
Very rarely was he interested in
a bijective proof or a sign reversing involution, instead
he would reduce a result to a calculation which he was
a master of proving.
The most profound example is his work
with his student Stephen Milne on finding a
bijective proof of the Rogers--Ramanujan identity;
something for which George Andrews was offering a \$50 prize.
The {\it Garsia--Milne involution
principle} came from their efforts to prove this
identity combinatorially, allowed them to collect
the prize money, and proved to be
more interesting than the combinatorial proof of Rogers--Ramanujan
identity itself.
The method takes a signed sum over a combinatorial set
and reduces it to a positive sum by combining
two involutions and a bijection.  The construction
produces a non-explicit bijection of the positive
set of objects that may
require several iterations to compute.

Garsia also made influential contributions to the study of
Cohen–Macaulay posets and rings. He conjectured that all
Cohen–Macaulay posets are partitionable, a statement reflecting
that strong algebraic conditions should manifest
themselves in combinatorial structure. While the analogous
conjecture for Cohen–Macaulay simplicial complexes was disproved
in 2017 by Duval, Klivans, and Martin, Garsia’s poset conjecture
is strictly weaker and remains open, continuing to shape current
work in the area.

In 1988, Adriano Garsia invited Ian G. Macdonald
to visit U.C. San Diego where
gave a series of lectures on what would become known as
{\it Macdonald polynomials}.  Adriano became interested
...
functions were conjectured to be a transformed form of the Macdonald
polynomial which became known as the {\it $n!$-conjecture}.
Armed with this conjecture, they expected to prove
the Macdonald positivity conjecture within a matter
of months.  It was eventually proven by Mark Haiman
over a decade later using deep results algebraic geometric.
He promised a monetary reward to anyone
who could prove the $n!$-conjecture using elementary techniques.
\newpage 
