...
identity combinatorially.
The method takes a signed sum over a combinatorial set
and reduces it to a positive sum by combining
two involutions and a bijection and solves the problem by iterating these maps to
compute a non-explicit bijection between the two target sets.
This allowed them to collect
the prize money, but more importantly
the method of proof was ultimately
more interesting than the combinatorial
proof of Rogers--Ramanujan
identity itself.
